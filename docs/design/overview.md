...
7. **[mobile-workflow.md](mobile-workflow.md)** — Obsidian Mobile でのノート作成ワークフロー、Templater 連携

### 参考

8. **[feature-coverage.md](feature-coverage.md)** — org-roam-review / obsidian-sr との機能比較、v0.1 カバー率、将来のロードマップ
